...
HRESULT CObject_Manager::Out_GameObject(_uint iLevelIndex, const _wstring& strLayerTag, CGameObject* pGameObject)
{
	CLayer* pLayer = Find_Layer(iLevelIndex, strLayerTag);
	if (nullptr == pLayer)
		return E_FAIL;
...
HRESULT CObject_Manager::Out_GameObjectList(_uint iLevelIndex, const _wstring& strLayerTag)
{
	CLayer* pLayer = Find_Layer(iLevelIndex, strLayerTag);
	if (nullptr == pLayer)
		return E_FAIL;
...
HRESULT CObject_Manager::ReAdd_GameObject(_uint iLevelIndex, const _wstring& strLayerTag, CGameObject* pGameObject)
{
	CLayer* pLayer = Find_Layer(iLevelIndex, strLayerTag);
	if (nullptr == pLayer)
	{
